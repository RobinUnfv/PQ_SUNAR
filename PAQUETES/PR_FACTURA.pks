CREATE OR REPLACE PACKAGE FACTU.PR_FACTURA IS
 ...
 -- PROCEDIMIENTO QUE NOS VA PERMITIR DAR LA COMUNICACIÓN DE BAJA DE UN COMPROBANTE PAGO
 ...
 -- PROCEDIMIENTO QUE SE VA ENCARCAR DE REALIZAR LA CARGA DE TODOS LOS COMPROBANTES DE PAGO 
 ...
 -- PROCEDIMIENTO QUE NOS PERMITA LIMPIAR LA TABLA DE REGISTRO DE VENTA (FACTU.REG_VTA)
 PROCEDURE LIMPIAR_REGVTA (pNoCia IN FACTU.ARFAFE.NO_CIA%TYPE);
